...
if __name__ == '__main__':
    ...
    max_raw_angle = 2**14
    previous_raw_angles = offsets_right+ offsets_left
    ...
    try:
        ...
        while not exit_flag:
            ...
            gripper_pos = gripper_pos-700 if gripper_pos > 700 else 0
            gripper_pos = gripper_pos/1100.00 if gripper_pos < 1100 else 1.0
